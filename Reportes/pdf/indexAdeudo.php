...
$resultado=mysqli_query($conectar, "SELECT Alumno_Matricula, Semestre, Grupo, Fecha, Campus, Importe FROM adeudo WHERE Alumno_Matricula='$matricula'");
...
$fpdf->SetY(30);
$fpdf->Ln(5);
$fpdf->Cell(0, 5, 'Registro de Adeudos', 0, 0, 'C');
...
$fpdf->SetFont('Arial','',10);
	...
	while($row = $resultado->fetch_assoc())
	{
		...
		$fpdf->Cell(25,5,$row['Fecha'],0,0,'C',1);
