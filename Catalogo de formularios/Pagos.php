...
if (isset($_POST['boton1'])) {
 ...
 if ($matricula == "") {
      ...
      if ($existe==1) {
        ...
        mysqli_query($conectar,"INSERT INTO pago(idPago, Semestre, Grupo, Importe, fechaPago, Campus, Municipio, Alumno_Matricula)
         VALUES('','$semestre', '$grupo', '$importe','$fechapago', '$campus', '$municipio','$matricula')");
